...
proc ::calc::init {} {
  ...
  cmd doc -link [list "calc.ip"] "calc" {~*!math* <expression>~ - calculate expression.}
  cmd doc -link [list "calc"] "calc.ip" {~*!math* ip <ip>/<mask>~ - calculate ip network/broadcast/host range.}
